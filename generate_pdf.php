<?php
// pdf_generator.php - Improved version that accepts parameters directly
...
// For direct access via URL (backward compatibility)
if(isset($_GET['id'])) {
    try {
        ...
        header('Content-Disposition: ' . (isset($_GET['client_access']) ? 'attachment' : 'inline') . '; filename="invoice_'.$invoice_id.'.pdf"');
        echo $pdf_content;
    } catch (Exception $e) {
        die($e->getMessage());
    }
